...
def diff_to_target(theta1, theta2):
    ...
    diff = target_pose - forward_kinematics
    return diff

def inverse_kinematics(max_iterations, tolerance):
    ...
    for iteration in range(max_iterations):
        ...
        target_difference = diff_to_target(joint_angles[0], joint_angles[1])
...
result = inverse_kinematics(max_iterations, tolerance)
